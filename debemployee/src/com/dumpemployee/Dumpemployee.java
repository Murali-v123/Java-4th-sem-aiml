...
public class Dumpemployee {
	...
	public static void loadFromFile(String filePath) {
		...
		String sql = "INSERT INTO employee (name, email, course, marks) VALUES (?,?,?,?)";

		// try-with-resources: auto-closes Connection and PreparedStatement
		try (Connection con = Dbemployee.getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
